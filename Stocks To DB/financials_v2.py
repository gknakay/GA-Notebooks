...
def pull_financials():
    ...
    os.chdir('C:\\Users\\Gökhan Akay\\Desktop\\BeautifulSoup\\Financials_202203')
    ...
    for i in range(0,len(stocks_to_pull)):
        ...
        worksheet.move_range('C1:BB130', rows = 0, cols = 1)
        ...
        data = pd.DataFrame(yf.download(stock+'.IS','2022-04-01',today)['Close'])
        price = data['Close'][-1]
